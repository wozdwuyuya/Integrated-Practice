...
| 设备 | I2C 地址 | 说明 |
|------|----------|------|
| SSD1315 OLED | 0x3C | 128x64，兼容 SSD1306 驱动 |
| MAX30102 | 0x57 | 心率血氧，地址芯片固定 |
| MPU6050 | 0x68 | 六轴 IMU，AD0 悬空/接地=0x68 |
...
| 电源轨 | 来源 | 供电外设 |
|--------|------|----------|
| V3.3 (Pin 1) | TPS562200 降压 | KY-039、RGB 灯、蜂鸣器、SW-420、MPU6050、OLED、MAX30102 |
...
// MAX30102 心率血氧（max30102.c）
#define max30102_address_ID  0x57
...
### 8.2 I2C 读写（MAX30102/MPU6050/OLED 通用模式）
